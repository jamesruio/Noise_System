...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        tabViewController.viewControllers=[viewController1,viewController2,viewController3]
        ...
        item1.image=UIImage(named:"search")?.withRenderingMode(.alwaysOriginal)
        item1.title="查询"
        let item=tabBar.items![1]
        item.image=UIImage(named:"home")?.withRenderingMode(.alwaysOriginal)
        item.title="主页"
        let item2=tabBar.items![2]
        item2.image=UIImage(named:"me")?.withRenderingMode(.alwaysOriginal)
        item2.title="我的"
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "noise_system")
